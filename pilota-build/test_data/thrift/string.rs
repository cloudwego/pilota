    ...
    pub mod string {
        ...
        impl ::pilota::thrift::Message for A {
            ...
            fn decode<T: ::pilota::thrift::TInputProtocol>(
                ...
                let Some (faststr) = faststr else { return Err (:: pilota :: thrift :: DecodeError :: new (:: pilota :: thrift :: DecodeErrorKind :: InvalidData , "field faststr is required" . to_string ())) } ;
                let Some (string) = string else { return Err (:: pilota :: thrift :: DecodeError :: new (:: pilota :: thrift :: DecodeErrorKind :: InvalidData , "field string is required" . to_string ())) } ;
