    ...
    pub mod decode_error {
        ...
        impl ::pilota::thrift::Message for A {
            fn encode<T: ::pilota::thrift::TOutputProtocol>(
                ...
                protocol.write_struct_field(1i16, &self.b)?;
            ...
            fn decode<T: ::pilota::thrift::TInputProtocol>(
                ...
                let Some (b) = b else { return Err (:: pilota :: thrift :: DecodeError :: new (:: pilota :: thrift :: DecodeErrorKind :: InvalidData , "field b is required" . to_string ())) } ;
                let data = Self { b };
                Ok(data)
            }
            ...
            fn size<T: ::pilota::thrift::TLengthProtocol>(&self, protocol: &mut T) -> usize {
                ...
                protocol.write_struct_begin_len(&::pilota::thrift::TStructIdentifier { name: "A" })
                    + protocol.write_struct_field_len(Some(1i16), &self.b)
        ...
        impl ::pilota::thrift::Message for B {
            fn encode<T: ::pilota::thrift::TOutputProtocol>(
                ...
                protocol.write_struct_begin(&struct_ident)?;
                protocol.write_struct_field(2i16, &self.c)?;
                protocol.write_field_stop()?;
                protocol.write_struct_end()?;
                Ok(())
            }
            fn decode<T: ::pilota::thrift::TInputProtocol>(
                ...
                protocol.read_struct_end()?;
                let Some (c) = c else { return Err (:: pilota :: thrift :: DecodeError :: new (:: pilota :: thrift :: DecodeErrorKind :: InvalidData , "field c is required" . to_string ())) } ;
                let data = Self { c };
                Ok(data)
            }
            async fn decode_async<T: ::pilota::thrift::TAsyncInputProtocol>(
            ...
            fn size<T: ::pilota::thrift::TLengthProtocol>(&self, protocol: &mut T) -> usize {
                ...
                protocol.write_struct_begin_len(&::pilota::thrift::TStructIdentifier { name: "B" })
                    + protocol.write_struct_field_len(Some(2i16), &self.c)
                    + protocol.write_field_stop_len()
                    + protocol.write_struct_end_len()
            }
        }
        ...
        impl ::pilota::thrift::Message for C {
            fn encode<T: ::pilota::thrift::TOutputProtocol>(
                ...
                protocol.write_struct_begin(&struct_ident)?;
                protocol.write_faststr_field(3i16, (&self.a).clone())?;
                protocol.write_field_stop()?;
                protocol.write_struct_end()?;
                Ok(())
            }
            fn decode<T: ::pilota::thrift::TInputProtocol>(
                ...
                protocol.read_struct_end()?;
                let Some (a) = a else { return Err (:: pilota :: thrift :: DecodeError :: new (:: pilota :: thrift :: DecodeErrorKind :: InvalidData , "field a is required" . to_string ())) } ;
                let data = Self { a };
                Ok(data)
            }
            async fn decode_async<T: ::pilota::thrift::TAsyncInputProtocol>(
            ...
            fn size<T: ::pilota::thrift::TLengthProtocol>(&self, protocol: &mut T) -> usize {
                ...
                protocol.write_struct_begin_len(&::pilota::thrift::TStructIdentifier { name: "C" })
                    + protocol.write_faststr_field_len(Some(3i16), &self.a)
                    + protocol.write_field_stop_len()
                    + protocol.write_struct_end_len()
            }
        }
