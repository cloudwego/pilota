pub mod protobuf_options_reference {
    ...
    impl ::pilota::pb::Message for BankTransferInfo {
        #[inline]
        fn encoded_len(&self) -> usize {
            0 + ::pilota::pb::encoding::faststr::encoded_len(1, &self.account_number)
                + ::pilota::pb::encoding::faststr::encoded_len(2, &self.bank_name)
                + ::pilota::pb::encoding::faststr::encoded_len(3, &self.swift_code)
        }

        #[allow(unused_variables)]
        fn encode_raw(&self, buf: &mut ::pilota::LinkedBytes) {
            ::pilota::pb::encoding::faststr::encode(1, &self.account_number, buf);
            ::pilota::pb::encoding::faststr::encode(2, &self.bank_name, buf);
            ::pilota::pb::encoding::faststr::encode(3, &self.swift_code, buf);
        }
    ...
    impl ::pilota::pb::Message for DatabaseOptions {
        #[inline]
        fn encoded_len(&self) -> usize {
            ...
            }) + ::pilota::pb::encoding::message::encoded_len_repeated(4, &self.indexes)
        }
    ...
    impl ::pilota::pb::Message for CryptoCurrencyInfo {
        #[inline]
        fn encoded_len(&self) -> usize {
            0 + ::pilota::pb::encoding::faststr::encoded_len(1, &self.wallet_address)
                + ::pilota::pb::encoding::faststr::encoded_len(2, &self.currency_type)
        }

        #[allow(unused_variables)]
        fn encode_raw(&self, buf: &mut ::pilota::LinkedBytes) {
            ::pilota::pb::encoding::faststr::encode(1, &self.wallet_address, buf);
            ::pilota::pb::encoding::faststr::encode(2, &self.currency_type, buf);
        }
    ...
    impl ::pilota::pb::Message for PaymentInfo {
        #[inline]
        fn encoded_len(&self) -> usize {
            0 + ::pilota::pb::encoding::int32::encoded_len(1, &self.id)
                + ::pilota::pb::encoding::faststr::encoded_len(2, &self.user_id)
                + ::pilota::pb::encoding::double::encoded_len(3, &self.amount)
                + self
                    .payment_method
                    .as_ref()
        ...
        fn encode_raw(&self, buf: &mut ::pilota::LinkedBytes) {
            ...
            ::pilota::pb::encoding::faststr::encode(2, &self.user_id, buf);
            ::pilota::pb::encoding::double::encode(3, &self.amount, buf);
        ...
        fn merge_field(
            ...
            match tag {
                ...
                3 => {
                    ...
                    ::pilota::pb::encoding::double::merge(wire_type, _inner_pilota_value, buf, ctx)
                        .map_err(|mut error| {
    ...
    impl ::pilota::pb::Message for CreditCardInfo {
        #[inline]
        fn encoded_len(&self) -> usize {
            0 + ::pilota::pb::encoding::faststr::encoded_len(1, &self.card_number)
                + ::pilota::pb::encoding::faststr::encoded_len(2, &self.cardholder_name)
                + ::pilota::pb::encoding::faststr::encoded_len(3, &self.expiration_date)
        }

        #[allow(unused_variables)]
        fn encode_raw(&self, buf: &mut ::pilota::LinkedBytes) {
            ::pilota::pb::encoding::faststr::encode(1, &self.card_number, buf);
            ::pilota::pb::encoding::faststr::encode(2, &self.cardholder_name, buf);
            ::pilota::pb::encoding::faststr::encode(3, &self.expiration_date, buf);
        }
        ...
        fn merge_field(
            ...
            match tag {
                1 => {
                    ...
                    ::pilota::pb::encoding::bool::merge(wire_type, _inner_pilota_value, buf, ctx)
                        .map_err(|mut error| {
    ...
    impl ::pilota::pb::Message for DebitCardInfo {
        #[inline]
        fn encoded_len(&self) -> usize {
            0 + ::pilota::pb::encoding::faststr::encoded_len(1, &self.card_number)
                + ::pilota::pb::encoding::faststr::encoded_len(2, &self.holder_name)
                + ::pilota::pb::encoding::faststr::encoded_len(3, &self.bank_name)
        }

        #[allow(unused_variables)]
        fn encode_raw(&self, buf: &mut ::pilota::LinkedBytes) {
            ::pilota::pb::encoding::faststr::encode(1, &self.card_number, buf);
            ::pilota::pb::encoding::faststr::encode(2, &self.holder_name, buf);
            ::pilota::pb::encoding::faststr::encode(3, &self.bank_name, buf);
        }
    ...
    impl ::pilota::pb::Message for ApiMetadata {
        #[inline]
        fn encoded_len(&self) -> usize {
            ...
            }) + ::pilota::pb::encoding::faststr::encoded_len_repeated(5, &self.tags)
                + ::pilota::pb::encoding::message::encoded_len_repeated(6, &self.examples)
        }
        ...
        fn encode_raw(&self, buf: &mut ::pilota::LinkedBytes) {
            ...
            ::pilota::pb::encoding::faststr::encode_repeated(5, &self.tags, buf);
    ...
    pub mod api_metadata {
        ...
        impl ::pilota::pb::Message for Example {
            #[inline]
            fn encoded_len(&self) -> usize {
    ...
    pub mod database_options {
        ...
        impl ::pilota::pb::Message for IndexOptions {
            #[inline]
            fn encoded_len(&self) -> usize {
                ...
                }) + ::pilota::pb::encoding::faststr::encoded_len_repeated(3, &self.fields)
            }
            ...
            fn encode_raw(&self, buf: &mut ::pilota::LinkedBytes) {
                ...
                ::pilota::pb::encoding::faststr::encode_repeated(3, &self.fields, buf);
            }
    ...
    pub mod payment_info {
        ...
        impl PaymentMethod {
            pub fn encode(&self, buf: &mut ::pilota::LinkedBytes) {
                match self {
                    PaymentMethod::CreditCard(value) => {
                        ::pilota::pb::encoding::message::encode(4, (&*value), buf);
                    }
                    PaymentMethod::DebitCard(value) => {
                        ::pilota::pb::encoding::message::encode(5, (&*value), buf);
                    }
                    PaymentMethod::BankTransfer(value) => {
                        ::pilota::pb::encoding::message::encode(6, (&*value), buf);
                    }
                    PaymentMethod::Crypto(value) => {
                        ::pilota::pb::encoding::message::encode(7, (&*value), buf);
                    }
                }
            }
            ...
            pub fn encoded_len(&self) -> usize {
                match self {
                    PaymentMethod::CreditCard(value) => {
                        ::pilota::pb::encoding::message::encoded_len(4, &*value)
                    }
                    PaymentMethod::DebitCard(value) => {
                        ::pilota::pb::encoding::message::encoded_len(5, &*value)
                    }
                    PaymentMethod::BankTransfer(value) => {
                        ::pilota::pb::encoding::message::encoded_len(6, &*value)
                    }
                    PaymentMethod::Crypto(value) => {
                        ::pilota::pb::encoding::message::encoded_len(7, &*value)
                    }
                }
            }
