    ...
    impl ::pilota::prost::Message for A {
        ...
        fn encoded_len(&self) -> usize {
            0 + self.a.as_ref().map_or(0, |value| {
                ::pilota::prost::encoding::string::encoded_len(1, value)
            }) + ::pilota::prost::encoding::string::encoded_len(2, &self.b)
        }
            ...
            B: ::pilota::prost::bytes::BufMut,
        {
            if let Some(_pilota_inner_value) = self.a.as_ref() {
                ::pilota::prost::encoding::string::encode(1, _pilota_inner_value, buf);
            }
            ::pilota::prost::encoding::string::encode(2, &self.b, buf);
        }
