...
namespace rs thrift_reflection
...
struct ConstValueDescriptor{
    ...
    2:required double value_double (pilota.rust_type = "ordered_f64") // for double
    ...
    7:optional map<ConstValueDescriptor,ConstValueDescriptor> value_map (pilota.rust_type = "btree") // for map
    8:required string value_identifier // for identifier, such as another constant's name
    9:optional map<string,string> extra (pilota.rust_type = "btree") // extra info 
}
